...
class _CartProductState extends State<CartProduct> {
  ...
  void increateProductQuantity(Product product) {
            ...
            children: [
              Container(
                decoration: BoxDecoration(
                  border:
                      Border.all(color: GlobalVaribales.peachYello, width: 1.5),
                  ...
                  children: [
                    ...
                    DecoratedBox(
                      decoration: BoxDecoration(
                          ...
                          color: GlobalVaribales.peachYello,
                    ...
                    InkWell(
                      onTap: () => increateProductQuantity(product),
                      child: Container(
                        width: 35,
                        height: 32,
                        color: GlobalVaribales.purpulecus,
